...
# # Sous-titre
# st.header("Bienvenue sur l'interface dédiée à la station de dessalement Wave 2")

# # Image ou bannière (remplacer par le chemin de votre image)
# # st.image("static/image1.webp", caption="Station de dessalement Wave 2 - Jorf Lasfar", use_column_width=True)

# # Texte descriptif
# st.write(
#     """
#     ### À propos de la station Wave 2
#     La station de dessalement Wave 2 de Jorf Lasfar est une infrastructure essentielle pour répondre 
#     aux besoins croissants en eau potable et industrielle au Maroc. Ce projet utilise des technologies 
#     innovantes pour offrir une production durable et efficace.
#     """
# )
...
# st.write(
#     """
#     #### Ce que vous trouverez sur cette interface :
#     - **Suivi en temps réel** des performances opérationnelles (débits, consommation énergétique, etc.).
#     - **Données historiques et analyses** pour comprendre les tendances de production.
#     - **Documentation technique** pour explorer les spécifications des équipements et des processus.
#     """
# )

# # Objectifs de la station
# st.subheader("🌍 Mission de Wave 2")
# st.write(
#     """
#     - Fournir une solution durable au stress hydrique dans la région.
#     - Répondre aux besoins en eau potable des zones avoisinantes, notamment Casablanca et El Jadida.
#     - Minimiser l'impact environnemental grâce à des technologies avancées.
#     """
# )

# # Boutons ou liens vers d'autres sections
# st.markdown("### 🚀 Explorez les autres sections dans le menu de gauche.")


# # Footer
# st.markdown("---")
# st.markdown("© 2025 Station de Dessalement Wave 2 - Jorf Lasfar | Interface développée  par DIPS")
import streamlit as st
import pandas as pd
from PIL import Image
import base64
